...
const userData =[
    {id:'1',username:'tuananh',email:'tuanan@gmail.com',password:'1234'},
    {id:'2',username:'tuananh1',email:'tuanan1@gmail.com',password:'12345'},
    {id:'3',username:'tuananh2',email:'tuanan2@gmail.com',password:'12346'},
];
export default function App({ navigation }) {
   ...
   const handleContinue = () => {
        if (username && email && password) {
            userData.push({ username, email, password }); // Có thể thêm người dùng mới
